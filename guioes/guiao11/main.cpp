...
void prepareCylinder(float altura, float raio, int lados) {
	...
	float raioTex = 1 - 0.8125;
	float divisoes = 1.0 / lados;
	...
	for (int i = 0; i < lados; ++i) {
		...
		vertex++;
		t[vertex*2 + 0] = 0.4375 + raioTex*sin(i*delta);
		t[vertex*2 + 1] = 0.1875 + raioTex*cos(i*delta);
		n[vertex*3 + 0] = 0;
		n[vertex*3 + 1] = 1.0f;
		n[vertex*3 + 2] = 0;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.4375 + raioTex*sin((i+1)*delta);
		t[vertex * 2 + 1] = 0.1875 + raioTex*cos((i+1)*delta);
		n[vertex*3 + 0] = 0;
		n[vertex*3 + 1] = 1.0f;
		n[vertex*3 + 2] = 0;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.8125 + raioTex * sin((i + 1) * delta);
		t[vertex * 2 + 1] = 0.1875 + raioTex * cos((i + 1) * delta);
		n[vertex*3 + 0] = 0.0f; 
		n[vertex*3 + 1] = -1.0f;
		n[vertex*3 + 2] = 0.0f;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.8125 + raioTex * sin(i * delta);
		t[vertex * 2 + 1] = 0.1875 + raioTex * cos(i * delta);
		n[vertex*3 + 0] = 0.0f; 
		n[vertex*3 + 1] = -1.0f;
		n[vertex*3 + 2] = 0.0f;
